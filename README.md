...
An overall pseudo-random number generator seed was set at 1234 for all code. To reproduce the results below, the same seed should be used.
...
trainingset <- read.csv("C:/Users/User/Downloads/pml-traning.csv", na.strings=c("NA","#DIV/0!", ""))

# Loading the testing data set 
testingset <- read.csv('C:/Users/User/Downloads/pml-testing.csv', na.strings=c("NA","#DIV/0!", ""))
